...
const outPdf = "C:\\Users\\MaxContentSeO\\Downloads\\SEO_Audit_Showcase_v16.pdf";
const outHtml = path.join(repoRoot, "qa_output", "seo_audit_showcase_v16.html");
const outReport = path.join(repoRoot, "qa_output", "qa_report_v16.md");
...
pages.push(
  page(
    ...
    `
      ...
      ${p("*Der Audit-Betrag (490 EUR) wird vollständig auf das Quick Fix Paket angerechnet. Effektiver Gesamtpreis: 690 EUR.", "small")}
